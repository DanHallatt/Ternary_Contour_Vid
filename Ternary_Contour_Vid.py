    ...
    ** Colour : In quotations (such as 'Blues') the colour of the contour plot. Options available according to 'cmap' of matplotlib (https://matplotlib.org/stable/tutorials/colors/colormaps.html).
    ...
    def Tern_Base():
        ...
        if type == 'silicate':
            ...
            ax.annotate('Fe', xy=(-0.55,0.), xytext = (-0.57,-0.03))
            ax.annotate('Mg', xy=(0.55,0.), xytext = (0.53, -0.03))
        ...
        if type == 'silicateHydration':
            ...
            ax.annotate('O', xy=(-0.55,0.0), xytext = (-0.57,-0.03))
    ...
    def init_TernVid():
        ...
        xx_TernVid_temp, yy_TernVid_temp = np.mgrid[xmin_TernVid_temp:xmax_TernVid_temp:200j, ymin_TernVid_temp:ymax_TernVid_temp:200j]
        ax.contourf(xx_TernVid_temp, yy_TernVid_temp, np.zeros((200, 200)), NumLevels, cmap=Colour)
        ax.axis('off')
    ...
    for j in range(NumberOfSteps):
        ...
        xx_TernVid, yy_TernVid = np.mgrid[xmin_TernVid:xmax_TernVid:200j, ymin_TernVid:ymax_TernVid:200j]
